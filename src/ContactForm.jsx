...
function ContactForm() {
  const [state, handleSubmit] = useForm("mzbnwzvd");
  if (state.succeeded) {
    return (
      <p>
        Merci, Votre message a bien été transmis, je vous répondrai dans les
        meilleurs délais!
      </p>
    );
  }
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      <input type="telephone" name="telephone" id="telephone" placeholder="Votre numéro de téléphone(facultatif)" />
      <textarea
        placeholder="Parlez moi de votre projet"
        id="message"
        name="message"
